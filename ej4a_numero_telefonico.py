# Ejercicio 4 - Ejercicio de cadenas
...
def run():
    numero = input("Ingrese el numero de la empresa con el siguiente formato porfavor +XX-XXXXXXXXX-XX:  ")
    print("El numero de telefono sin prefijo y extensión es " + str(numero[2:11]))
